  ...
  return (
    <Card>
      <CardContent>
        ...
        >
          <Grid item xs={6}>
            <Typography sx={{textTransform:"uppercase", fontWeight:"bold"}} variant="subtitle2">Height</Typography>
            <Typography variant="body2">{pokemon.height}</Typography>
          </Grid>
          <Grid item xs={6}>
            <Typography sx={{textTransform:"uppercase", fontWeight:"bold"}} variant="subtitle2">Weight</Typography>
            <Typography variant="body2">{pokemon.weight}</Typography>
          </Grid>
          <Grid item xs={6}>
            <Typography sx={{textTransform:"uppercase", fontWeight:"bold"}}  variant="subtitle2">Types</Typography>
          ...
          <Grid item xs={6}>
            <Typography sx={{textTransform:"uppercase", fontWeight:"bold"}}  variant="subtitle2">Abilities</Typography>
